...
<div id="audio-player" style="max-width: 500px; margin: 2em 0; padding: 1.5em; border: 1px solid #ddd; border-radius: 8px; background: #fafafa;">
  <audio id="audio" preload="metadata">
    <source src="https://static.jujhar.com/music/2025-05-03-keerat-singh-gujari-workshop.mp3" type="audio/mpeg">
  ...
  <div style="display: flex; align-items: center; gap: 8px; font-size: 0.85em;">
    ...
    <span style="margin-left: auto;">
      <a href="https://static.jujhar.com/music/2025-05-03-keerat-singh-gujari-workshop.mp3" download style="text-decoration: none;">⬇ Download MP3</a>
    </span>
  </div>
</div>
