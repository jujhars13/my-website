...
<div id="audio-player" style="max-width: 500px; margin: 2em 0; padding: 1.5em; border: 1px solid #ddd; border-radius: 8px; background: #fafafa;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; font-size: 0.85em;">
    ...
    <span style="margin-left: auto;">
      <a href="https://static.jujhar.com/music/2026-04-28-bhai-kultar-singh-workshop-shaheedi-bunga-leicester-too-beant-ko-virla-janai-vadhans.mp3" download style="text-decoration: none;">⬇ Download MP3</a>
    </span>
  </div>
</div>
